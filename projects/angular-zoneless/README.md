...
> The Angular-specific library.<br /> It provides a convenient way to use Maskito as a directive in angular zoneless
> seutp.

## How to install

```
npm i @maskito/{core,angular-zoneless}
```
